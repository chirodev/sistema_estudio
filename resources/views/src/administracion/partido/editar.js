...
export default class EditarPartidoPolitico extends Component {
    ...
    get_data() {
        axios.get( '/partido_politico/edit/' + this.props.match.params.id).then(
            (response) => {
            ...
            <div className="main-content">
                <section className="section">
                    <h1 className="section-header">
                        <div>Editar Partido Politico</div>
                    </h1>
                    <div className="row">
